...
<html xmlns="http://www.w3.org/TR/REC-html40" lang="en">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="<?PHP echo base_url();?>images/siti.ico" />
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                <ul class="nav navbar-nav">
                                  ...
                                  <?php if($this->session->userdata('tipo_empleado_id')==1):?>
                                     <li><a href="<?PHP echo base_url(); ?>index.php/acceso/inicio_administrador">Inicio</a></li>
                                  <?php endif ?>  
                                    <?php foreach($_SESSION['modulos'] as $padre):?>
                                        <?php if(count($padre->modulos_hijos)>0):?>
                                            <li class="dropdown">
                                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $padre->mod_descripcion?><span class="caret"></span></a>
