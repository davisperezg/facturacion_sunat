...
<html>
    ...
    <body>
        ...
        <div id="div_header">
            ...
            <div id="logo">
                <div align="right">
                    <img class="responsive" aling="right" src="<?PHP FCPATH;?>images/empresas/<?php echo $empresa['foto'];?>" style="text-align:center;" ><br>
                </div>                
            </div>    
        </div>
        ...
        <div style="padding-top: 10px;">
            ...
            <div id="numero">
                <div align="right">
                    <table align="right">
                    <tr>
                        <td style="background-color: #af660c; color: white"><b>Número:</b></td>
                        <td style="background-color: #af660c; font-size: 20px; color: white"><b><?php echo $cabecera['serie']."-".$cabecera['numero']."<br>"?></b></td>
                    </tr>
                    <tr>
        ...
        <table style="width: 100%" border="1" cellspacing="0" cellpadding="0" class="detalle">
            <thead>
                <tr style="background-color: #af660c; color: white">
                    <th>CANT.</th>
                    <th>U.M.</th>
                    <th>COD.</th>
                    <th>DESCRIPCIÓN</th>
        ...
        <table class="totales" style="width: 100%">            
            ...
            <tr>
                ...
                <td style="background-color: #af660c; color: white"><b>Total</b></td>
                <td style="background-color: #af660c; color: white"><b><?php echo $cabecera['simbolo_moneda']?></b></td>
                <td style="background-color: #af660c; color: white" class="derecha_text"><b><?php echo number_format($cabecera['total_a_pagar'] - $anticipo_total_pagar, 2)?></b></td>
            </tr>
            <?php }
            
            if(($cabecera['detraccion_codigo'] != null) && ($cabecera['detraccion_codigo'] != '') && ($cabecera['detraccion_porcentaje'] != '') && ($cabecera['detraccion_porcentaje'] > 0)){
                $valor_detraccion = $cabecera['detraccion_porcentaje'];
                ?>
            <tr>                
                <td></td>
                <td></td>
                ...
                <td>Detracción</td>
                <td><?php echo $cabecera['simbolo_moneda']?></td>
                <td class="derecha_text"><?php echo number_format($cabecera['detraccion_porcentaje'] * $cabecera['total_a_pagar'] * (0.01),2)?></td>
            </tr>
            <?php
            }
            if(isset($cabecera['retencion_porcentaje']) && ($cabecera['retencion_porcentaje'] != '') && ($cabecera['retencion_porcentaje'] > 0)){
                $valor_retencion = $cabecera['retencion_porcentaje'];
                ?>
            <tr>
                <td></td>
                <td></td>
                ...
                <td>Retención</td>
                <td><?php echo $cabecera['simbolo_moneda']?></td>
                <td class="derecha_text"><?php echo number_format($cabecera['retencion_porcentaje'] * $cabecera['total_a_pagar'] * (0.01),2)?></td>
            </tr>
            <?php
            }
            if((isset($cabecera['retencion_porcentaje']) && ($cabecera['retencion_porcentaje'] != '') && ($cabecera['retencion_porcentaje'] > 0)) || (isset($cabecera['retencion_porcentaje']) && ($cabecera['retencion_porcentaje'] != '') && ($cabecera['retencion_porcentaje'] > 0))){?>
            <tr>
                <td></td>
                <td></td>
                <td></td>
                ...
                <td><?php echo $cabecera['simbolo_moneda']?></td>
                <td class="derecha_text"><?php echo number_format($cabecera['total_a_pagar'] - ($valor_detraccion * $cabecera['total_a_pagar'] * (0.01))  - ($valor_retencion * $cabecera['total_a_pagar'] * (0.01)),2)?></td>
            </tr>
            <?php
            }?>
        </table>
