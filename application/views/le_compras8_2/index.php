...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#btn_nuevo_libro_compra").click(function(){
            $("#myModal").load('<?php echo base_url()?>index.php/le_compras8_2/modal_nuevo');
        });
        ...
        $('#tabla_id').on('click', '.btn-generar', function(){
            ...
            var url_insert = base_url + 'index.php/le_compras8_2_detalles/ingresarDatosLibros/' + mes + '/' + anio;
            $.getJSON(url_insert)
            .done(function (data) {            
            });
    
            let url_l = base_url + 'index.php/le_compras8_2/generar/#' + datos_id;
    ...
    function carga_inicial(){
        ...
        var url_l = base_url + 'index.php/WS_le_compras8_2/ws_select/';
        $.getJSON(url_l)
        .done(function (data) {
            var numero_orden = 1;
